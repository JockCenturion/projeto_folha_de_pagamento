...
public class FuncionarioMensalista extends Funcionario {
	...
	public void processaEvento(Evento e) throws FolhaException {
		if (e.getTipoEvento().equals("folha.EventoHoraExtra")){	//alteracao de EventoHoraExtra --> folha.EventoHoraExtra
			this.horasExtras += e.getValorEvento();
		}
		else if (e.getTipoEvento().equals("folha.EventoFalta")){
			this.faltas++;
		}
		else if (e.getTipoEvento().equals("folha.EventoAtraso")){
